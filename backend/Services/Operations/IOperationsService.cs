...
public interface IOperationsService
{
    ...
    Task<PurchaseListItem> UpdatePurchaseAsync(long id, UpdatePurchaseRequest request, string? userId, bool canOverrideLineLimits, CancellationToken ct);
    ...
    Task<InventorySaleDetailsResponse> GetSaleAsync(long id, CancellationToken ct);
    ...
    Task<InventorySaleListItem> UpdateSaleAsync(long id, UpdateInventorySaleRequest request, string? userId, bool canOverrideLineLimits, CancellationToken ct);
    Task DeleteSaleAsync(long id, string? userId, CancellationToken ct);
    Task<IReadOnlyList<InventorySaleReturnResponse>> GetSaleReturnsAsync(long saleId, CancellationToken ct);
    Task<InventorySaleReturnResponse> CreateSaleReturnAsync(long saleId, CreateInventorySaleReturnRequest request, string? userId, CancellationToken ct);
