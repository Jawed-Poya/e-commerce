...
public sealed class AdminDocumentsController(IFinancialDocumentService documents) : ControllerBase
{
    ...
    {
        var content = await documents.CreateProductsPdfAsync(filter, cancellationToken);
    ...
    public async Task<IActionResult> SalesPdf(
        ...
        CancellationToken cancellationToken)
    {
        var content = await documents.CreateSalesPdfAsync(filter, cancellationToken);
    ...
    public async Task<IActionResult> PurchasesPdf(
        ...
        CancellationToken cancellationToken)
    {
        var content = await documents.CreatePurchasesPdfAsync(filter, cancellationToken);
    ...
    public async Task<IActionResult> PayrollPdf(
        ...
        CancellationToken cancellationToken)
    {
        var content = await documents.CreatePayrollPdfAsync(filter, cancellationToken);
    ...
    public async Task<IActionResult> ExpensesPdf(
        ...
        CancellationToken cancellationToken)
    {
        var content = await documents.CreateExpensesPdfAsync(filter, cancellationToken);
