...
const keys: Record<string, string> = {
    ...
    "Dashboard": "nav.dashboard", "Reports": "nav.reports", "Products": "nav.products", "Reviews": "nav.reviews", "Inventory": "nav.inventory", "Orders": "nav.orders", "Prescription requests": "nav.prescriptions", "Customers": "nav.customers",
