...
export default function CustomersPage() {
    ...
    const submit = (event: FormEvent) => { event.preventDefault(); create.mutate({ firstName: form.firstName.trim(), lastName: clean(form.lastName), phone: form.phone.trim(), email: clean(form.email), address: clean(form.address), customerTypeId: null }); };
