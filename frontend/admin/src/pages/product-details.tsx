...
import { ProductPerformanceCard } from "@/features/finance/components/product-performance-card";
...
export default function ProductDetailsPage() {
    ...
    return <div className="space-y-6">
        ...
        {canViewFinancialReports ? <ProductPerformanceCard productId={product.id} /> : null}
