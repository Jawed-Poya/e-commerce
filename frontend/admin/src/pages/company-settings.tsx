                    ...
                    >
                        ...
                        <section className="rounded-2xl border border-primary/15 bg-primary/[0.025] p-4 sm:p-5">
                            ...
                            <div className="mt-5 grid gap-5 sm:grid-cols-2 xl:grid-cols-4">
                                ...
                                <Toggle label="Allow negative stock" description="Enabled by default: manual sales can go below zero and later purchases automatically offset the deficit." checked={settings.allowNegativeStockSales} onCheckedChange={(checked) => setSettings({ ...settings, allowNegativeStockSales: checked })} />
                            </div>
    ...
    return (
        ...
        >
                ...
                <div className="mt-4 flex flex-col gap-2 border-t pt-3 sm:flex-row sm:flex-wrap sm:items-center">
                    ...
                    {value ? <Button type="button" size="sm" variant="ghost" className="w-full sm:w-auto" disabled={disabled || upload.isPending} onClick={() => onChange(null)}><X />{tr("Remove")}</Button> : null}
