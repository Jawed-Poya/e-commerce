        ...
        <div className="space-y-5 sm:space-y-6">
            ...
            <Card className="border-destructive/25">
                ...
                <CardContent className="grid gap-4 lg:grid-cols-3">
                    ...
                    <ActionCard icon={<Sparkles />} title={tr("Load professional demo")} description={tr("Clear current business data and create realistic pharmacy products, lightweight images, customers, inventory, purchase, sale, order, expense, and staff examples.")} controls={<Button disabled={!canSeed} onClick={() => openAction({ kind: "seed", phrase: "LOAD DEMO DATA" })}><Sparkles />{tr("Load demo data")}</Button>} />
                </CardContent>
            </Card>
